...
SECRET_KEY = 'django-insecure-nku+f9_k9(g8zaeuyeaf*z!)=8-tplk2))r+84=y4@x(8xvjy9'
...
DATABASES = {
    'default': {
        ...
        'PASSWORD': os.getenv('DB_PASSWORD', 'BanglaMart2026'),
...
CELERY_BEAT_SCHEDULE = {
    ...
    "cleanup-old-verified-otps": {
        ...
        "schedule": 60 * 60 * 24,  # every 2 minutes 
    },
